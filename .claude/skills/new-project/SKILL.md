...
## Steps
1. Clarify: project name, stack, category (docs | full-stack-ai | dev-tools),
...
## Reuse
Prefer `scripts/project-init.sh` stacks over hand-rolling scaffolding; surface its
available templates to the user.
