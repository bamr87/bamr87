...
description: Reconcile dash/_data/projects.yml (the project registry) with .gitmodules and GitHub repo metadata. Use when a submodule or repo was added/removed/renamed, or the registry looks out of date.
---

# update-registry

The registry `dash/_data/projects.yml` is the single source of truth for the dash.
Keep it in sync with reality.

## Steps

1. Read `.gitmodules` and `dash/_data/projects.yml`.
