---
mode: ask
description: Add a new REST API endpoint with Pydantic models, service, and router (sourced from microsoft/skills)
---

<!-- Source: skills/.github/prompts/add-endpoint.prompt.md (microsoft/skills submodule) -->
