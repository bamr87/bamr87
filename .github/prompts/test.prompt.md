...
describe('UserService', () => {
  ...
  describe('error handling', () => {
    ...
    test('should handle database connection failure', async () => {
      // Arrange
      database.users.create.mockRejectedValue(new Error('Connection timeout'));
...
**Component**: [What we're testing] **Critical Paths**: [Most important functionality] **Edge Cases**: [Boundary conditions to test] **Error Conditions**: [Failure modes to handle (DFF)]
...
**Expected Coverage**: [X]% **Critical Paths Covered**: [Y]% **Test Count**: [Z] tests
